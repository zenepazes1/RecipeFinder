...
namespace RecipeFinder.DataAccess.Migrations
{
    ...
    [Migration("20240524101333_initDouble")]
    partial class initDouble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeFinder.DataAccess.Entities.CategoryEntity", b =>
                {
            ...
            modelBuilder.Entity("RecipeFinder.DataAccess.Entities.FavoriteRecipeEntity", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecipeFinder.DataAccess.Entities.ApplicationUserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecipeFinder.DataAccess.Entities.FavoriteRecipeEntity", b =>
                {
                    ...
                    b.HasOne("RecipeFinder.DataAccess.Entities.ApplicationUserEntity", "User")
                        .WithMany("FavoriteRecipes")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RecipeFinder.DataAccess.Entities.RecipeEntity", b =>
                {
                    b.HasOne("RecipeFinder.DataAccess.Entities.ApplicationUserEntity", "Author")
                        .WithMany("Recipes")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RecipeFinder.DataAccess.Entities.CategoryEntity", "Category")
                        .WithMany("Recipes")
